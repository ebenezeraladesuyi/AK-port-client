...
const ServicesCard:React.FC<serviceCard> = ({icon, title, details}) => {
  return (
    <div className="w-full flex flex-col md:flex-row  items-center justify-between md:items-start gap-6">
