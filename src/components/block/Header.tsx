...
const Header = () => {
  ...
  return (
    <motion.div className={`w-full h-[90px] lg:h-[130px flex lg:justify-center items-center font-pop fixed z-40 bg-[#000000 text-white  transition-all duration-1000 ease-in-out ${isScrolled ? 'bg-[#000000c8] shadow-md' : 'bg-[#00000064]'}`}
